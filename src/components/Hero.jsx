  ...
  return (
    <div className='max-w-[100rem] mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3  justify-between items-center xl:items-start pt-9 pb-16 md:gap-1'>
      <div className=" lg:pl-10 pl-6 md:pl-2  md:flex md:flex-col md:items-center xl:items-start xl:pt-16">
        ...
        <p className='text-sm font-normal pb-1 text-gray-500'>This amount refers to the TP rates only</p>

        <div className='pt-10 space-y-4'>
          <div className='bg-gradient-to-r from-[#FFF2EB] via-[#FFF7F2] to-white
 w-full py-2 pl-2 pr-10 rounded-md mt-3 md:mt-1'>
            <div className='flex items-center space-x-4'>
              ...
              <p className='text-sm'>Doorstep Cashless RepairsH</p>
          ...
          <div className='bg-gradient-to-r from-[#FFF2EB] via-[#FFF7F2] to-white
 w-full p-2 rounded-md mt-3  md:mt-1'>
            <div className='flex items-center space-x-4 '>
              ...
              <p className='text-sm'>₹15 lakh Personal Accident Cover</p>
            </div>
          </div>
          <div className='bg-gradient-to-r from-[#FFF2EB] via-[#FFF7F2] to-white
 w-full p-2 rounded-md mt-3  md:mt-1'>
            <div className='flex items-center space-x-4'>
              ...
              <p className='text-sm'>Drive less? Pay less with PAYD add-on</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col justify-center items-center pt-8'>
        <div className="form rounded-xl border border-gray-300  lg:mx-8 md:mx-2 lg:p-4 p-4 xl:p-6 xl:pb-0 md:p-5 w-[295px]  md:w-[320px] lg:w-[300px] xl:w-[430px] md:mt-2 xl:h-[415px]">
          <form action="" className='flex flex-col gap-3 lg:gap-y-5 md:gap-4 pb-2'>
            <input type="text" placeholder='Car registration no.' className='p-2 border border-gray-300 rounded-md lg:py-3 lg:px-4 py-2 px-2' />
            <input type="text" placeholder='Mobile no.' className='p-2 border border-gray-300 rounded-md lg:py-3 lg:px-4 py-2 px-2' />
            <input type="text" placeholder='Email' className='p-2 border border-gray-300 rounded-md lg:py-3 lg:px-4 py-2 px-2' />
            <button className="bg-[#EC6608] text-white font-bold lg:py-3 lg:px-4 py-2 px-2 rounded mb-2">Get quote </button>
          </form>
          <div class="flex flex-col gap-y-4 pb-2">
            <a className='text-[#EC6608] hover:underline'>Retrieve quote</a>
            <div>
              <input type="checkbox" value="" class="accent-[rgb(236_102_8/1)]" />
              <label class="ms-2 text-sm font-small text-gray-700">I agree to the <a href="#" class="underline">terms and conditions</a>.</label>
            </div>

          </div>
        </div>
        <div className='text-center bg-[rgba(255,242,235,1)] py-3 px-2 md:px-0 rounded-b-2xl xl:w-[367px] md:w-[270px] w-[250px]'>
          <a className='text-[#EC6608] underline'>Renew your ICICI Lombard policy</a>
        </div>
