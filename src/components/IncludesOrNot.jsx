...
const IncludesOrNot = () => {
    ...
    return (
        <div className='bg-[#F8F6F6]'>
            <div className='lg:p-10 p-3 md:p-3  xl:h-[607px] max-w-[100rem] mx-auto  '>
                <p className='text-4xl text-center font-bold pb-5'>What’s included and what’s not?</p>
                ...
                <div className='border-t border-gray-200 pt-5'>
                    <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 lg:gap-0 text-sm xl:text-base md:text-xs lg:text-[11px] font-bold text-orange-600'>
